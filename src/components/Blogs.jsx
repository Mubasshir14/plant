...
const Blogs = () => {
    return (
        <div className='my-10'>
            ...
            <Link to='/blogs1' className='transform transition-transform duration-300 hover:scale-105 overflow-hidden group container rounded-lg flex justify-center items-center mx-auto h-[200px] bg-cover relative'>
                ...
                <Link to='blogs2' className='transform transition-transform duration-300 hover:scale-105 overflow-hidden group container rounded-lg flex justify-center items-center mx-auto h-[200px] bg-cover relative'>
                    <div className='rounded-xl overflow-hidden'>
