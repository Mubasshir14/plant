...
import logo from '../assets/Tree/rec/PAP1.png'
const Footer = () => {
    return (
        <div>
            <footer className="bg-[#436E35] text-white">
                <div className="container p-6 mx-auto">
                    <div className="lg:flex">
                        <div className="w-full -mx-6 lg:w-2/5">
                            <div className="px-6">
                                ...
                                <div className="flex mt-6 -mx-2 text-white">
                                    <a href="#"
                                        className="mx-2 transition-colors duration-300 text-white hover:text-blue-500 dark:hover:text-blue-400"
                                        aria-label="Reddit">
                        ...
                        <div className="mt-6 lg:mt-0 lg:flex-1">
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                <div>
                                    ...
                                    <a href="#" className="block mt-2 text-sm text-whitehover:underline">Company</a>
                                    <a href="#" className="block mt-2 text-sm text-whitehover:underline">community</a>
                                    <a href="#" className="block mt-2 text-sm text-whitehover:underline">Careers</a>
                                </div>
                        ...
                        <div>
                            <p className="text-center text-white">© Plant A PLant 2024 - All rights reserved</p>
                        </div>
                </div>
            </footer>
        </div>
